...
namespace TweetCountChecker.Common
{
    /// <summary>
    ...
    internal static class AssemblyInfo
    {
        ...
        static AssemblyInfo()
        {
            ...
            Version = a.GetName().Version ?? new Version();
            ApplicationPath = a.Location;
            DirectoryPath = Path.GetDirectoryName(a.Location) ?? "";
        }

        /// <summary>
        /// 指定した属性を指定した型のカスタム属性に変換します。
        /// </summary>
        /// <typeparam name="T">変換先のカスタム属性の型。</typeparam>
        /// <param name="assembly">変換元の属性。</param>
        /// <returns>変換したカスタム属性。変換できなかった場合は null。</returns>
